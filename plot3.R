...
# Time series of Sub metering stations (dates are in spanish since that's my locale)

png(file="figure/plot3.png", width=480, height=480,bg="transparent")

plot(pow.cons$datetime, pow.cons$Sub_metering_1)
...
legend("topright", legend=colnames(pow.cons[,7:9]), lty=1, col=cols)
